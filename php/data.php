...
$metadata = '
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-171255987-1"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag("js", new Date());

      gtag("config", "UA-171255987-1");
    </script>
    
    <title>Slogive Skills</title>
...
$NavContactenos = "contactenos";

$NavServiciosUrl = "servicios";
$NavServiciosClass = "Icon-Contactenos";
$NavServicios = "servicios";

$NavTestimoniosUrl = "testimonios";
$NavTestimoniosClass = "Icon-Contactenos";
$NavTestimonios = "testimonios";

$NavSoporteUrl = "soporte";
$NavSoporteClass = "Icon-Contactenos";
$NavSoporte = "soporte";

$NavLinksUtiles = "links utiles";
$NavInformacion = "informacion";
$NavContactenos = "contactenos";
?>